<ul class="account-nav">
    ...
    <li><a href="{{ route('user.orders.index') }}" class="menu-link menu-link_us-s">Orders</a></li>
    <li><a href="{{ route('user.addresses.index') }}" class="menu-link menu-link_us-s">Addresses</a></li>

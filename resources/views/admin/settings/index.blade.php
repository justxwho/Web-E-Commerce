                            ...
                            <form name="account_edit_form" action="{{ route('admin.settings.update') }}" method="POST"
                                ...
                                <fieldset class="name">
                                    ...
                                    <input class="flex-grow" type="text" placeholder="Full Name" name="name"
                                        tabindex="0" value="{{ old('name', $admin->name) }}" aria-required="true"
                                        required="">
                                </fieldset>
                                ...
                                <fieldset class="name">
                                    ...
                                    <input class="flex-grow" type="text" placeholder="Mobile Number" name="mobile"
                                        tabindex="0" value="{{ old('mobile', $admin->mobile) }}" aria-required="true"
                                        required="">
                                </fieldset>
                                ...
                                <fieldset class="name">
                                    ...
                                    <input class="flex-grow" type="text" placeholder="Email Address" name="email"
                                        tabindex="0" value="{{ old('email', $admin->email) }}" aria-required="true"
                                        required="">
                                </fieldset>

                                <fieldset>
                                    <div class="body-title">Avatar <span class="tf-color-1">*</span></div>
                                    <div class="upload-image flex-grow">
                                        <div class="item" id="imgpreview"
                                            style="{{ $admin->avatar ? 'display:block' : 'display:none' }}">
                                            <img src="{{ $admin->avatar ? asset('uploads/avatars/' . $admin->avatar) : '' }}"
                                                class="effect8" alt="avatar"
